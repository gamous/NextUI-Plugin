...
namespace NextUIPlugin.Service {
	...
	internal class ManagedLoadContext : AssemblyLoadContext {
		...
		public ManagedLoadContext(
			...
			this.basePath = Path.GetDirectoryName(mainAssemblyPath) ??
			                throw new ArgumentException("Invalid assembly path", nameof(mainAssemblyPath));
			...
			this.defaultAssemblies = defaultAssemblies != null
			...
			this.additionalProbingPaths = additionalProbingPaths ??
			                              throw new ArgumentNullException(nameof(additionalProbingPaths));
		...
		protected override Assembly? Load(AssemblyName assemblyName) {
			...
			if ((this.preferDefaultLoadContext || this.defaultAssemblies.Contains(assemblyName.Name)) &&
			    !this.privateAssemblies.Contains(assemblyName.Name)) {
			...
			if (!string.IsNullOrEmpty(assemblyName.CultureName) &&
			    !string.Equals(assemblyName.CultureName, "neutral")) {
