namespace NextUIPlugin.NetworkStructures {
	public enum ServerZoneIpcType : ushort {
		...
		// updated 4.5 ? this actually looks like the two opcodes have been combined, see #474
		MSQTrackerProgress = 0xF1CD,
		...
		// - display dialogue pop-ups in duties and FATEs, for example, Teraflare's countdown
		DirectorPopUp = 0xF162, // updated 5.18
		...
		// called ron or double ron (waiting for action must be flagged from discard packet to call)
		MahjongEndRoundRon = 0x2C0, 
	...
	*/
	public enum ServerChatIpcType : ushort {
		...
		// added 4.5, this is used when receiving a /tell in PublicContent instances such as Eureka or Bozja
		PublicContentTell = 0x00FB,
	...
	public enum ClientChatIpcType : ushort {
		...
		// updated 5.35 hotfix, this is used when sending a /tell in PublicContent instances such as Eureka or Bozja
		PublicContentTellReq = 0x0326,
	};
}